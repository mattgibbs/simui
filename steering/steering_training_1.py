...
class SteeringDisplay(Display):
    ...
    def initialize_orbit(self):
        ...
        orbit = Orbit(["BPMS:LI26:201", "BPMS:LI26:301", "BPMS:LI26:401"], auto_connect=False, parent=self)
        self.x_magnet_list = MagnetList("X", "xcor_list_training_1.json", parent=self)
